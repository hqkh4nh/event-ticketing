export const en = {
  ...
  notifications: {
    ...
    types: {
      ...
      WITHDRAWAL_SUBMITTED: {
        ...
        body: '{{organizerName}} is requesting a payout.',
      },
      WITHDRAWAL_APPROVED: {
        title: 'Withdrawal approved',
        body: 'Your request has been approved and is waiting to be transferred.',
      },
      WITHDRAWAL_REJECTED: {
      ...
      WITHDRAWAL_PAID: {
        ...
        body: 'Your withdrawal has been transferred to your bank account.',
      },
      unknown: {
  ...
  admin: {
    ...
    withdrawals: {
      ...
      description:
        'Approve a request, transfer the money by hand, then record the result.',
      searchLabel: 'Find a request',
      searchPlaceholder: 'Organizer name or email address',
      clearSearch: 'Clear search',
      resultTitle: 'Requests',
      resultCount: '{{count}} requests',
      bankSummary: '{{bank}} • {{account}} • {{holder}}',
      submittedAt: 'Submitted {{date}}',
      noteSummary: 'Organizer note: {{note}}',
      rejectionSummary: 'Rejected: {{reason}}',
      referenceSummary: 'Reference: {{reference}}',
      loadErrorTitle: 'Unable to load withdrawal requests',
      emptyTitle: 'No requests found',
      emptyDescription: 'Try another filter or search term.',
      confirmApproveTitle: 'Approve this withdrawal?',
      confirmApproveDescription:
      ...
      reasonPlaceholder: 'Explain what the Organizer needs to fix',
      rejectedSuccess: 'Request rejected and the Organizer was notified.',
      confirmPaidTitle: 'Record this transfer?',
      confirmPaidDescription:
        'Only do this after {{amount}} has actually reached {{organizer}}. This cannot be undone.',
      referenceLabel: 'Transfer reference',
      referencePlaceholder: 'FT26080812345',
      referenceHelper: 'The bank reference, for reconciliation later.',
      adminNoteLabel: 'Internal note',
      adminNotePlaceholder: 'Optional, visible to administrators only',
      paidSuccess: 'Transfer recorded and the Organizer was notified.',
    },
    profile: {
      title: 'Admin account',
  ...
  organizer: {
    ...
    account: {
      ...
      withdrawals: 'Withdrawals',
      withdrawalsDescription: 'Request a payout of your ticket revenue',
      security: 'Account security',
      securityDescription: 'Change your sign-in password',
      preferences: 'Preferences',
      language: 'Language',
    ...
    error: {
      ...
      withdrawalAmountInvalid: 'Enter an amount greater than 0',
      withdrawalAmountTooSmall: 'The smallest withdrawal is {{amount}}',
      withdrawalAmountTooLarge: 'You can withdraw at most {{amount}}',
      bankNameRequired: 'Please enter the bank name',
      bankAccountNumberRequired: 'Please enter the account number',
      bankAccountHolderRequired: 'Please enter the account holder name',
    },
    withdrawals: {
      title: 'Withdrawals',
      status: {
        PENDING: 'Awaiting review',
        APPROVED: 'Approved, transfer on the way',
        PAID: 'Transferred',
        REJECTED: 'Rejected',
        CANCELLED: 'Cancelled',
      },
      ...
      withdrawn: 'Already transferred',
      settlementNote:
        'Only revenue from events that have already ended can be withdrawn, so this is lower than the revenue on your dashboard.',
      minimumNote: 'The smallest withdrawal is {{amount}}.',
      newRequest: 'Request a withdrawal',
      historyTitle: 'History',
      bankSummary: '{{bank}} • {{account}}',
      rejectionSummary: 'Rejected: {{reason}}',
      referenceSummary: 'Transfer reference: {{reference}}',
      loadErrorTitle: 'Unable to load withdrawals',
      emptyTitle: 'No withdrawals yet',
      emptyDescription: 'Your requests will appear here once you make one.',
      confirmCancelTitle: 'Cancel this request?',
      confirmCancelDescription:
        '{{amount}} returns to your available balance right away.',
      newTitle: 'Request a withdrawal',
      newDescription:
        'An administrator reviews the request and transfers the money to the account below by hand.',
      ...
      bankAccountHolderHelper:
        'Exactly as the bank prints it, otherwise the transfer will fail.',
      noteLabel: 'Note',
      notePlaceholder: 'Optional, visible to the administrator',
      submit: 'Send request',
    },
  },
  ...
  statistics: {
    ...
    export: {
      action: 'Export revenue report',
      title: 'Export revenue report',
      description: 'Choose a date range and the data to export.',
      period: 'Date range',
      from: 'From',
      to: 'To',
      preset: {
      ...
      rangeSummary: '{{count}} days, based on Vietnam time.',
      invalidRange: 'Choose a range between 1 and {{max}} days.',
      reportType: 'CSV report type',
      summary: 'Summary by event',
      summaryDescription: 'Paid orders, tickets, and revenue for each event.',
      detail: 'Order details',
      detailDescription: 'Each ticket type in paid orders.',
      shareTitle: 'Save or share revenue report',
      success: 'The CSV report has been created.',
  ...
  api: {
    error: {
      ...
      WITHDRAWAL_AMOUNT_TOO_SMALL:
        'The amount is below the smallest withdrawal allowed.',
      WITHDRAWAL_AMOUNT_EXCEEDS_BALANCE:
        'The amount is above your available balance.',
      WITHDRAWAL_REQUEST_ALREADY_OPEN:
        'You already have a withdrawal being processed. Wait for it to finish before requesting another.',
    },
